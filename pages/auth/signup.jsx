...
export default function SignUp() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const data = await axios.post('https://education-fijh.onrender.com/auth/signUp', formdata) // Fetch the data
      setIsSubmit(false)
      ...
      <main className="flex  justify-center items-center py-5 overflow-x-hidden ">
        ...
        <div className="w-[40rem] mx-4 z-10">
          ...
          <div className="text-center form-header">
            ...
            <h2 className="ct-1 text-2xl font-semibold mb-2">
              اهلا بك معنا
            </h2>
            <p className="ct-3">
              من فضل قم بتسجيل بياناتك للمتابعة
            </p>
          </div>
          {/* form main content */}
          <form onSubmit={handleSubmit}
            onChange={handleValidation} className="card mt-5 rounded-lg p-5 lg:p-7 shadow-lg shadow-[#0000000d] border-neutral-800 border br-card   ">
            <Toaster />

            <div className="inputs-groupe flex  gap-2 ">
              {/* ========== first name ========== */}
              <label className="mb-3 block w-full">
                <span className="text-start ct-0">
                  أسم الطالب  :
                </span>
              ...
              <label className="mb-3 block w-full">
                <span className="text-start ct-0">أسم اﻷب  :
                </span>
                <span className="relative mt-1.5 flex">
                  <input ref={lastName}
            ...
            <label className="mb-3 block ">
              ...
              <p className="mt-2 text-red-600 hidden" id='email-alert'>من فضلك ادخل بريد الكتروني  صحيح !</p>
            </label>
            <div className="inputs-groupe flex gap-2 ">
              {/* ============== Phone Number ============= */}
              <label className="mb-3 block w-full">
                <span className="text-start ct-0">رقم الهاتف :
                </span>
                <span className="relative mt-1.5 flex">
                  <input maxLength={11}
                    ref={phoneNumber}
                ...
                <p className="mt-2 text-red-600 hidden" id='phone-number-alert'>من فضلك ادخل رقم هاتف صحيح !</p>
              </label>
              {/* ============== Parent Number ============= */}

              <label className="mb-3 block w-full">
                <span className="text-start ct-0">رقم ولي الأمر :
                </span>
                <span className="relative mt-1.5 flex">
                  <input maxLength={11}
                    ref={parentNumber}
            ...
            <div>
              <label className="mb-3 block">
                <span className="text-start ct-0">رقم الواتساب   :
                </span>
                <span className="relative mt-1.5 flex">
                  <input maxLength={11}
                    ref={whatsAppNumber}
                ...
                <p className="mt-2 text-red-600 hidden" id='whatsapp-number-alert'>من فضلك ادخل رقم هاتف صحيح !</p>
              </label>
                ...
                <label className=' w-full'>
                  ...
                  <span className="relative mt-1.5 flex ">
                    ...
                    <span className=' cfg-main  absolute end-[35px] translate-y-1/2 z-50 ct-2 hover:cursor-pointer'>
                      {
                        isVisible ? (
                          <Eye id='re-password-eye'
                            onClick={toggleVisibility}
                            size={20} />
                        ) : (
                          <EyeSlash id='re-password-eye'
                            onClick={toggleVisibility}
                            size={20} />
                        )
                      } </span>
                  </span>
                  <p className="mt-2 text-red-600 hidden" id='re-password-alert'>لابد ان يكون الرقم السري متطابق!</p>
              ...
              <ul className="mt-2 text-red-600 hidden text-sm list-disc ps-5 flex-grow-1" id='password-alert'>
                ...
                <li id='letter-v'>
                  حرف أبجدي واحد على الأقل سواء كان بحروف صغيرة أو كبيرة.</li>
                <li id='digit-v'>
                  رقم واحد على الأقل.</li>
                <li id='symbol-v'>
                  حرف خاص واحد على الأقل (من بين @$!%*#?&).</li>
            ...
            <label className="my-5 block">
              ...
              <p className="mt-2 text-red-600 hidden" id='national-id-alert'> من فضلك ادخل رقم قومي صحيح مكون من 14 رقم !</p>
            </label>
            ...
            <div className="inputs-groupe flex gap-2  sm:flex-row flex-col ">
              ...
              <label className='w-full'>
                ...
                <p className="mt-2 text-red-600 hidden" id='government-alert'> لا يمكن ان يكون حقل المحافظه فارغ !</p>
              ...
              <label className='w-full'>
                ...
                <p className="mt-2 text-red-600 hidden" id='city-alert'>لا يمكن ان يكون حقل المدينه فارغ !</p>
            ...
            <label className='w-full'>
              ...
              <p className="mt-2 text-red-600 hidden" id='school-alert'>لا يمكن ان يكون حقل المدرسة فارغ !</p>

            </label>
            {/* =========== Upload image =============== */}
            <div className='upload-image-wrapper mt-5'>
              <label htmlFor="upload-image" className='flex flex-col items-center justify-center text-center  p-3 ct-2 hover:text-gray-700 cursor-pointer border-2 border-dashed rounded-md'>
                <input
                  ref={profilePicture}
                  type="file"
                  name="upload-image"
            ...
            <div className='ct-2 text-sm mt-3 inline-block '>
              ...
              <Link target='_blank' href="https://wa.me/201061005364" className="ct-2 text-sm mt-3 inline-block hover:text-[#000000c7] dark:hover:text-[#fff]">
                &ensp;     التواصل مع الدعم
              </Link>
            </div>
            {
              !isSubmit ? <Button disabled type='submit' className="h-9 w-full mt-5 cbg-primary ct-5 cbg-primary-hover rounded-lg text-md disabled:opacity-40">
                <span>تسجيل</span>
              </Button> : <Button type='submit' className="h-9 w-full mt-5 cbg-primary ct-5 cbg-primary-hover rounded-lg text-md" isLoading>
                <span>تسجيل</span>
              </Button>
            }
            <p className="ct-2 text-sm mt-4 text-center">
              تمتلك حساب ؟
              <Link className="ct-primary" href="/auth/login">
                &ensp;تسجيل الدخول
              </Link>
            </p>
          </form>
          <div>
            <p className="text-center text-s ct-3 mt-10 ">
              Developed by
              <Link href='https://www.facebook.com/mahmoudmagdy47' className='hover:text-[#4f46e5] ct-2'>Mahmoud Magdy</Link>
              &
              <Link href='https://www.facebook.com/ahmedashrafaly22' className='ct-2 hover:text-[#4f46e5]'>Ahmed ashraf</Link>
            </p>
          </div>
        </div>
      </main>
